...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lt0/a;->h(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
.end annotation
...
.field final synthetic h:Lt0/a;


# direct methods
.method constructor <init>(Lt0/a;Landroid/os/CancellationSignal;Landroid/print/PrintAttributes;Landroid/graphics/Bitmap;Landroid/print/PrintAttributes;ILandroid/os/ParcelFileDescriptor;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lt0/a$a;->h:Lt0/a;

    iput-object p2, p0, Lt0/a$a;->a:Landroid/os/CancellationSignal;

    iput-object p3, p0, Lt0/a$a;->b:Landroid/print/PrintAttributes;

    iput-object p4, p0, Lt0/a$a;->c:Landroid/graphics/Bitmap;

    iput-object p5, p0, Lt0/a$a;->d:Landroid/print/PrintAttributes;

    iput p6, p0, Lt0/a$a;->e:I

    iput-object p7, p0, Lt0/a$a;->f:Landroid/os/ParcelFileDescriptor;

    iput-object p8, p0, Lt0/a$a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 1
    :try_start_0
    iget-object p1, p0, Lt0/a$a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v1, v1, Lt0/a;->a:Landroid/content/Context;

    iget-object v2, p0, Lt0/a$a;->b:Landroid/print/PrintAttributes;
    ...
    .line 3
    iget-object v1, p0, Lt0/a$a;->c:Landroid/graphics/Bitmap;
    ...
    .line 5
    invoke-static {v1, v2}, Lt0/a;->a(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 6
    iget-object v2, p0, Lt0/a$a;->a:Landroid/os/CancellationSignal;
    ...
    iget-object v6, p0, Lt0/a$a;->h:Lt0/a;

    iget-object v6, v6, Lt0/a;->a:Landroid/content/Context;

    iget-object v7, p0, Lt0/a$a;->d:Landroid/print/PrintAttributes;
    ...
    iget v7, p0, Lt0/a$a;->e:I

    .line 16
    invoke-static {v5, v6, v2, v7}, Lt0/a;->c(IILandroid/graphics/RectF;I)Landroid/graphics/Matrix;
    ...
    .line 23
    iget-object p1, p0, Lt0/a$a;->f:Landroid/os/ParcelFileDescriptor;
    :try_end_2
    ...
    :cond_4
    :try_start_4
    iget-object p1, p0, Lt0/a$a;->c:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Lt0/a$a;->f:Landroid/os/ParcelFileDescriptor;
...
.method protected b(Ljava/lang/Throwable;)V
    ...
    .line 1
    iget-object v0, p0, Lt0/a$a;->a:Landroid/os/CancellationSignal;
    ...
    .line 2
    iget-object p1, p0, Lt0/a$a;->g:Landroid/print/PrintDocumentAdapter$WriteResultCallback;
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lt0/a$a;->a([Ljava/lang/Void;)Ljava/lang/Throwable;
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lt0/a$a;->b(Ljava/lang/Throwable;)V
