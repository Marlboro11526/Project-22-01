...
.field private volatile j:Lj1/n$a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lj1/n$a<",
            "*>;"
...
.field private volatile k:Lcom/bumptech/glide/load/engine/d;
...
.method private e(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, Lcom/bumptech/glide/load/engine/g;->q(Ljava/lang/Object;)Ld1/d;
    ...
    iget-object v9, p0, Lcom/bumptech/glide/load/engine/v;->e:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v9}, Lcom/bumptech/glide/load/engine/g;->k()Ld1/h;

    move-result-object v9

    invoke-direct {v8, v7, v6, v9}, Lcom/bumptech/glide/load/engine/e;-><init>(Ld1/d;Ljava/lang/Object;Ld1/h;)V

    .line 6
    new-instance v6, Lcom/bumptech/glide/load/engine/d;

    iget-object v9, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object v9, v9, Lj1/n$a;->a:Ld1/e;

    iget-object v10, p0, Lcom/bumptech/glide/load/engine/v;->e:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v10}, Lcom/bumptech/glide/load/engine/g;->p()Ld1/e;

    move-result-object v10

    invoke-direct {v6, v9, v10}, Lcom/bumptech/glide/load/engine/d;-><init>(Ld1/e;Ld1/e;)V

    .line 7
    iget-object v9, p0, Lcom/bumptech/glide/load/engine/v;->e:Lcom/bumptech/glide/load/engine/g;

    invoke-virtual {v9}, Lcom/bumptech/glide/load/engine/g;->d()Lh1/a;

    move-result-object v9

    .line 8
    invoke-interface {v9, v6, v8}, Lh1/a;->b(Ld1/e;Lh1/a$b;)V
    ...
    .line 13
    :cond_0
    invoke-interface {v9, v6}, Lh1/a;->a(Ld1/e;)Ljava/io/File;
    ...
    .line 14
    iput-object v6, p0, Lcom/bumptech/glide/load/engine/v;->k:Lcom/bumptech/glide/load/engine/d;

    .line 15
    new-instance p1, Lcom/bumptech/glide/load/engine/c;

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object v0, v0, Lj1/n$a;->a:Ld1/e;
    ...
    .line 17
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object p1, p1, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/v;->k:Lcom/bumptech/glide/load/engine/d;
    ...
    iget-object v6, v0, Lj1/n$a;->a:Ld1/e;
    ...
    iget-object v8, v0, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;
    ...
    .line 22
    invoke-interface {v0}, Lcom/bumptech/glide/load/data/d;->c()Ld1/a;

    move-result-object v9

    iget-object v0, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object v10, v0, Lj1/n$a;->a:Ld1/e;

    move-object v5, p1

    .line 23
    invoke-interface/range {v5 .. v10}, Lcom/bumptech/glide/load/engine/f$a;->d(Ld1/e;Ljava/lang/Object;Lcom/bumptech/glide/load/data/d;Ld1/a;Ld1/e;)V
    :try_end_3
...
.method private j(Lj1/n$a;)V
    ...
    invoke-direct {v2, p0, p1}, Lcom/bumptech/glide/load/engine/v$a;-><init>(Lcom/bumptech/glide/load/engine/v;Lj1/n$a;)V
...
.method public a(Ld1/e;Ljava/lang/Exception;Lcom/bumptech/glide/load/data/d;Ld1/a;)V
    ...
    invoke-interface {p4, p1, p2, p3, v0}, Lcom/bumptech/glide/load/engine/f$a;->a(Ld1/e;Ljava/lang/Exception;Lcom/bumptech/glide/load/data/d;Ld1/a;)V
...
.method public b()Z
    ...
    .line 9
    iput-object v1, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;
    ...
    check-cast v1, Lj1/n$a;

    iput-object v1, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    .line 12
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;
    ...
    .line 13
    invoke-virtual {v1}, Lcom/bumptech/glide/load/engine/g;->e()Lf1/a;

    move-result-object v1

    iget-object v3, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object v3, v3, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;

    invoke-interface {v3}, Lcom/bumptech/glide/load/data/d;->c()Ld1/a;

    move-result-object v3

    invoke-virtual {v1, v3}, Lf1/a;->c(Ld1/a;)Z
    ...
    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/engine/v;->j(Lj1/n$a;)V
...
.method public d(Ld1/e;Ljava/lang/Object;Lcom/bumptech/glide/load/data/d;Ld1/a;Ld1/e;)V
    ...
    iget-object p4, p0, Lcom/bumptech/glide/load/engine/v;->j:Lj1/n$a;

    iget-object p4, p4, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;

    invoke-interface {p4}, Lcom/bumptech/glide/load/data/d;->c()Ld1/a;
...
.method h(Lj1/n$a;Ljava/lang/Object;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Lcom/bumptech/glide/load/engine/g;->e()Lf1/a;
    ...
    .line 2
    iget-object v1, p1, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;

    invoke-interface {v1}, Lcom/bumptech/glide/load/data/d;->c()Ld1/a;

    move-result-object v1

    invoke-virtual {v0, v1}, Lf1/a;->c(Ld1/a;)Z
    ...
    iget-object v1, p1, Lj1/n$a;->a:Ld1/e;

    iget-object v3, p1, Lj1/n$a;->c:Lcom/bumptech/glide/load/data/d;
...
.method i(Lj1/n$a;Ljava/lang/Exception;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1}, Lcom/bumptech/glide/load/data/d;->c()Ld1/a;

    move-result-object v2

    invoke-interface {v0, v1, p2, p1, v2}, Lcom/bumptech/glide/load/engine/f$a;->a(Ld1/e;Ljava/lang/Exception;Lcom/bumptech/glide/load/data/d;Ld1/a;)V
