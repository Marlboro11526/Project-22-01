...
.field private final f:Lu2/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILu2/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    .line 11
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lu2/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    .line 1
    invoke-static {v1, v2}, Lg0/h;->a(ZLjava/lang/Object;)V

    .line 2
    sget-object v1, Ld2/l;->V2:[I
    ...
    .line 14
    invoke-static {p0, p1, v1}, Lr2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 25
    invoke-static {p0, v1, v0}, Lu2/k;->b(Landroid/content/Context;II)Lu2/k$b;

    move-result-object p0

    .line 26
    invoke-virtual {p0}, Lu2/k$b;->m()Lu2/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILu2/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    .line 3
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lu2/k;

    invoke-virtual {v0, v2}, Lu2/g;->setShapeAppearanceModel(Lu2/k;)V

    .line 4
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lu2/k;

    invoke-virtual {v1, v2}, Lu2/g;->setShapeAppearanceModel(Lu2/k;)V

    .line 5
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Lu2/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Lh0/w;->r0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
