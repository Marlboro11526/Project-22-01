...
.method private A(FFFI)Lu2/g;
    .locals 1

    .line 1
    invoke-static {}, Lu2/k;->a()Lu2/k$b;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p1}, Lu2/k$b;->A(F)Lu2/k$b;
    ...
    .line 4
    invoke-virtual {p1, p2}, Lu2/k$b;->s(F)Lu2/k$b;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p2}, Lu2/k$b;->w(F)Lu2/k$b;
    ...
    .line 8
    invoke-static {p2, p3}, Lu2/g;->m(Landroid/content/Context;F)Lu2/g;

    move-result-object p2

    .line 9
    invoke-virtual {p2, p1}, Lu2/g;->setShapeAppearanceModel(Lu2/k;)V

    const/4 p1, 0x0

    .line 10
    invoke-virtual {p2, p1, p4, p1, p4}, Lu2/g;->Z(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Lu2/g;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Lu2/g;
    ...
    invoke-static {p1, v2}, Lk2/a;->c(Landroid/view/View;I)I
    ...
    .line 5
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILu2/g;)V
    ...
    .line 6
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILu2/g;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILu2/g;)V
    .locals 5
    ...
    .line 2
    invoke-static {p2, v0, v1}, Lk2/a;->f(IIF)I
    ...
    .line 6
    invoke-static {p1, p3}, Lh0/w;->r0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 8
    invoke-virtual {p4}, Lu2/g;->C()Lu2/k;

    move-result-object v4

    invoke-direct {v0, v4}, Lu2/g;-><init>(Lu2/k;)V
    ...
    invoke-virtual {v0, v4}, Lu2/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    .line 11
    invoke-static {p1}, Lh0/w;->I(Landroid/view/View;)I
    ...
    .line 13
    invoke-static {p1}, Lh0/w;->H(Landroid/view/View;)I
    ...
    .line 15
    invoke-static {p1, p2}, Lh0/w;->r0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 16
    invoke-static {p1, p3, p4, v0, v1}, Lh0/w;->A0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILu2/g;)V
    .locals 7

    .line 1
    sget v0, Ld2/b;->l:I

    invoke-static {p1, v0}, Lk2/a;->c(Landroid/view/View;I)I
    ...
    .line 4
    invoke-static {p2, v0, v2}, Lk2/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Lu2/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-virtual {v1, v0}, Lu2/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Lu2/g;-><init>(Lu2/k;)V

    const/4 v0, -0x1

    .line 11
    invoke-virtual {p3, v0}, Lu2/g;->setTint(I)V
...
.method private varargs z(I[F)Landroid/animation/ValueAnimator;
    ...
    .line 2
    sget-object v0, Le2/a;->a:Landroid/animation/TimeInterpolator;
...
.method a()V
    ...
    .line 10
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lu2/g;
    ...
    .line 11
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Lu2/g;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Lu2/g;
    ...
    invoke-static {v2, v0}, Le/a;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
