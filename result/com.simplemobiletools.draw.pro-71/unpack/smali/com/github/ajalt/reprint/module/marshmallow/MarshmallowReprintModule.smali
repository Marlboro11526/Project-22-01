...
.field private final logger:Lc2/c$a;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lc2/c$a;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->logger:Lc2/c$a;
...
.method private fingerprintManager()Landroid/hardware/fingerprint/FingerprintManager;
    ...
    .line 2
    :catch_0
    iget-object v0, p0, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->logger:Lc2/c$a;

    const-string v1, "FingerprintManager not available on this device"

    invoke-interface {v0, v1}, Lc2/c$a;->b(Ljava/lang/String;)V
    ...
    .line 3
    iget-object v1, p0, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->logger:Lc2/c$a;

    const-string v2, "Could not get fingerprint system service on API that should support it."

    invoke-interface {v1, v0, v2}, Lc2/c$a;->a(Ljava/lang/Throwable;Ljava/lang/String;)V
...
# virtual methods
.method public authenticate(Ld0/b;Lc2/b;Lc2/c$b;)V
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-virtual {p0, p1, p2, p3, v0}, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->authenticate(Ld0/b;Lc2/b;Lc2/c$b;I)V

    return-void
.end method

.method authenticate(Ld0/b;Lc2/b;Lc2/c$b;I)V
    .locals 15
    ...
    invoke-direct/range {v1 .. v7}, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule$AuthCallback;-><init>(Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;ILc2/c$b;Ld0/b;Lc2/b;Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule$1;)V
    ...
    .line 9
    iget-object v0, v8, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->logger:Lc2/c$a;

    const-string v2, "MarshmallowReprintModule: authenticate failed unexpectedly"

    invoke-interface {v0, v1, v2}, Lc2/c$a;->a(Ljava/lang/Throwable;Ljava/lang/String;)V

    .line 10
    sget-object v10, Lc2/a;->l:Lc2/a;
    ...
    .line 12
    invoke-interface/range {v9 .. v14}, Lc2/b;->a(Lc2/a;ZLjava/lang/CharSequence;II)V
...
.method public hasFingerprintRegistered()Z
    ...
    .line 3
    iget-object v2, p0, Lcom/github/ajalt/reprint/module/marshmallow/MarshmallowReprintModule;->logger:Lc2/c$a;

    const-string v3, "MarshmallowReprintModule: hasEnrolledFingerprints failed unexpectedly"

    invoke-interface {v2, v0, v3}, Lc2/c$a;->a(Ljava/lang/Throwable;Ljava/lang/String;)V
