...
.method public final e(Landroid/content/Context;Ljava/lang/String;)Landroid/content/ContextWrapper;
    ...
    invoke-direct {p0, v0}, Ld3/g;->a(Landroid/content/res/Configuration;)Ljava/util/Locale;
    ...
    invoke-direct {p0, v0}, Ld3/g;->b(Landroid/content/res/Configuration;)Ljava/util/Locale;
    ...
    .line 9
    invoke-direct {p0, v0, v1}, Ld3/g;->c(Landroid/content/res/Configuration;Ljava/util/Locale;)V

    goto :goto_1

    .line 10
    :cond_1
    invoke-direct {p0, v0, v1}, Ld3/g;->d(Landroid/content/res/Configuration;Ljava/util/Locale;)V
    ...
    invoke-direct {p2, p1}, Ld3/g;-><init>(Landroid/content/Context;)V
