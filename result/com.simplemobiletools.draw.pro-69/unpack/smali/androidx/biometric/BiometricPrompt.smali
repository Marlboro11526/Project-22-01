...
.method public constructor <init>(Landroidx/fragment/app/Fragment;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    ...
    .line 9
    invoke-virtual {p1}, Landroidx/fragment/app/Fragment;->i()Landroidx/fragment/app/e;
    ...
    .line 11
    invoke-static {v0}, Landroidx/biometric/BiometricPrompt;->g(Landroidx/fragment/app/e;)Landroidx/biometric/f;
    ...
    .line 13
    invoke-direct {p0, v1, v0, p2, p3}, Landroidx/biometric/BiometricPrompt;->h(Landroidx/fragment/app/n;Landroidx/biometric/f;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
...
.method public constructor <init>(Landroidx/fragment/app/e;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    ...
    .line 3
    invoke-static {p1}, Landroidx/biometric/BiometricPrompt;->g(Landroidx/fragment/app/e;)Landroidx/biometric/f;

    move-result-object p1

    .line 4
    invoke-direct {p0, v0, p1, p2, p3}, Landroidx/biometric/BiometricPrompt;->h(Landroidx/fragment/app/n;Landroidx/biometric/f;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
...
.method private static a(Landroidx/fragment/app/Fragment;Landroidx/biometric/f;)V
    .locals 1

    if-eqz p1, :cond_0

    .line 1
    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->a()Landroidx/lifecycle/f;
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/f;->a(Landroidx/lifecycle/h;)V
...
.method private d(Landroidx/biometric/BiometricPrompt$d;Landroidx/biometric/BiometricPrompt$c;)V
    ...
    .line 6
    invoke-static {v0}, Landroidx/biometric/BiometricPrompt;->f(Landroidx/fragment/app/n;)Landroidx/biometric/d;

    move-result-object v0

    .line 7
    invoke-virtual {v0, p1, p2}, Landroidx/biometric/d;->G1(Landroidx/biometric/BiometricPrompt$d;Landroidx/biometric/BiometricPrompt$c;)V
...
.method private static f(Landroidx/fragment/app/n;)Landroidx/biometric/d;
    .locals 3

    .line 1
    invoke-static {p0}, Landroidx/biometric/BiometricPrompt;->e(Landroidx/fragment/app/n;)Landroidx/biometric/d;
    ...
    .line 2
    invoke-static {}, Landroidx/biometric/d;->W1()Landroidx/biometric/d;
...
.method private static g(Landroidx/fragment/app/e;)Landroidx/biometric/f;
    .locals 1
...
.method private h(Landroidx/fragment/app/n;Landroidx/biometric/f;Ljava/util/concurrent/Executor;Landroidx/biometric/BiometricPrompt$a;)V
    .locals 0
    ...
    .line 2
    invoke-virtual {p2, p3}, Landroidx/biometric/f;->S(Ljava/util/concurrent/Executor;)V

    .line 3
    :cond_0
    invoke-virtual {p2, p4}, Landroidx/biometric/f;->R(Landroidx/biometric/BiometricPrompt$a;)V
