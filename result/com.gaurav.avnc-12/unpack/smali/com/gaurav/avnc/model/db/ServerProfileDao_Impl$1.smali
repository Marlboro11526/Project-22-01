.class public Lcom/gaurav/avnc/model/db/ServerProfileDao_Impl$1;
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "INSERT OR ABORT INTO `profiles` (`ID`,`name`,`host`,`port`,`username`,`password`,`securityType`,`channelType`,`colorLevel`,`imageQuality`,`viewOnly`,`useLocalCursor`,`keyCompatMode`,`useRepeater`,`idOnRepeater`,`sshHost`,`sshPort`,`sshUsername`,`sshAuthType`,`sshPassword`,`sshPrivateKey`,`sshPrivateKeyPassword`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
